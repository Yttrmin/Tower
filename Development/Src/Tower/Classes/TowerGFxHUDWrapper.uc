class TowerGFxHUDWrapper extends UTHUDBase;

/** Copied from UTGFxHUDWrapper because MinimapHUDClass was restricted to its very specific minimap class. **/

/** Main Heads Up Display Flash movie */
var TowerGFxMinimapHUD   HudMovie;

/** Movie for non-functional sample inventory management UI */
var GFxProjectedUI      InventoryMovie;

/** Class of HUD Movie object */
var class<TowerGFxMinimapHUD> MinimapHUDClass;
...
DefaultProperties
{
	...
	MinimapHUDClass=class'TowerGFxMinimapHUD'
}